      ...
      <div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            ...
            <img src="/projetJEE/images/i7.jpeg" alt="" style="opacity:0.5;">
        ...
        <div class="container marketing">
          ...
          <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
            <c:choose>
              ...
              <p style=" color: white;"> Vous n'avez aucun album </p>
              </c:when>
          ...
          <div style="margin-top:1rem;" >
            <a class="btn btn-primary" data-toggle="modal" data-target="#addAlbum">
                <i class="fa fa-plus"></i>
							  <input type="file" accept="image/png, image/jpeg" class="hidden" id="files"style="display:none;">
					<label for="files">Ajouter</label>
