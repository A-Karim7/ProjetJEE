...
<jsp:useBean id="album" scope="request" type="beans.Albums"/>
<c:if  test="${!empty requestScope.images}">
    ...
    <html lang="en">
      <head>
        ...
        <style>
    body{
    background: linear-gradient(#191970, #9198e5);
    }
        ...
        <section class="py-5 text-center container" style="padding-bottom: 0px !important;">
            <div class="rows">
              <div class="col-lg-6 col-md-8 mx-auto">
                ...
                <h1 class="fw-light" style="color: white;"><c:out value="${album.theme }"/></h1>
                <p class="lead text-muted" style="color: white;">Something short and leading about the collection below—its contents, the creator, etc. Make it short and sweet, but not too short so folks don’t simply skip over it entirely.</p>
                <p>
                ...
                <div class="row" id="gallery" data-bs-toggle="modal" data-bs-target="#galleryModal">
                    <c:choose>
                        <c:when test="${ empty requestScope.images }">
                            <p style="color: white;"> La liste est vide </p>
                        </c:when>
                        <c:when test="${ !empty requestScope.images }">
